            ...
            if (aa_rand == 1) {
                ...
                for (let index = 0; index < 2; index++) {
                    enemybad = sprites.create(img`
                        ...
                        . . . b f f f f f b b . . . . . 
                        . . c 4 d f f 2 2 f b b . . . . 
                        b 4 4 4 d d f f 1 f f b . . . . 
                        . b 4 4 4 4 b f d f f b . . . . 
                        . . b 4 4 4 4 f f f f d b . . . 
                        . . b f f f f f f f f d d b . . 
                        . b f f f f f f f f d d d d b . 
                        . b f f f f f f f b b b d d d b 
                        . b f f f f f f c d f f b d d c 
                        . b f f f f f f d c d f d b b c 
                        . b d f f f f f d d c b f f b . 
                        . . b b f f f d d d d c c c b b 
                        . . . b b c c c c c c c c . . . 
                        `, SpriteKind.Enemy)
                    tiles.placeOnTile(enemybad, tiles.getTileLocation(20, randint(1, 20)))
                    enemybad.setVelocity(-20, randint(-20, 20))
            ...
            if (aa_rand == 1) {
                ...
                for (let index = 0; index < 4; index++) {
                    enemybad = sprites.create(img`
                        ...
                        . . . 2 2 2 2 . . . . . . . . . 
                        . . 2 4 4 4 4 2 2 . . . . . . . 
                        . 2 4 4 4 4 4 4 3 3 2 2 . . . . 
                        . 2 4 5 5 5 4 4 4 4 3 3 3 3 . . 
                        . 2 4 5 5 5 5 5 5 5 4 4 4 4 . . 
                        . 2 4 5 5 5 4 4 4 3 2 2 3 3 . . 
                        . . 2 4 4 4 4 3 2 2 . . . . . . 
                        . . . 2 2 2 2 . . . . . . . . . 
                        . . . . . . . . . . . . . . . . 
                        . . . . . . . . . . . . . . . . 
                        ...
                        `, SpriteKind.Enemy)
                    tiles.placeOnTile(enemybad, tiles.getTileLocation(20, randint(1, 20)))
                    enemybad.setVelocity(-150, randint(-20, 20))
                }
            }
        }
    }
